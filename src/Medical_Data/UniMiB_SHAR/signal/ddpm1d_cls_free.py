...
def train(args):
    ...
    device = args.device
    unimib_data = unimib_allClass()
    dataloader = data.DataLoader(unimib_data, batch_size=32, num_workers=4, shuffle=True)
    classes = 9
...
def launch():
    ...
    args.run_name = "DDPM1D_cls_free_UNIMIB"
    args.epochs = 300
    args.batch_size = 64
    args.seq_length = 128
    args.num_classes = 9
