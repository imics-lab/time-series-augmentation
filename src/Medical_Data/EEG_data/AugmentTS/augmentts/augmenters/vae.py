...
class LSTMVAE(VAEBase):
    def __init__(self, latent_dim=8, encoder_hiddens=[256, 128, 64], decoder_hiddens=[64, 128, 256], series_len=None, n_channels=None):
    ...
    def construct_encoder(self):
        encoder_inputs = keras.Input(shape=(self.n_channels, self.series_len))
    ...
    def construct_decoder(self):
        ...
        x = keras.layers.RepeatVector(self.n_channels)(latent_inputs)
        # stacking LSTM layers
