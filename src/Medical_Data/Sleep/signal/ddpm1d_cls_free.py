...
def train(args):
    ...
    device = args.device
    psg_data = psg_allClass()
    dataloader = data.DataLoader(psg_data, batch_size=32, num_workers=4, shuffle=True)
    classes = 2
...
def launch():
    ...
    args.run_name = "DDPM1D_cls_free_PSG"
    args.epochs = 300
    args.batch_size = 64
    args.seq_length = 512
    args.num_classes = 2
