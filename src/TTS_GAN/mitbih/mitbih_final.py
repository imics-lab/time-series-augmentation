...
if __name__ == "__main__":
    ...
    test_file = '../../Medical_Data/Mitbih/test_mitbih_new.csv'
    ...
    for file in file_list:
        ...
        class_id = int(value)
        print(class_id)
        model_id_path = '../logs_mitbih/'+file+'/Model/checkpoint'
        x_train_id, y_train_id = extract_one_class(class_id = class_id)

        #sample_size = x_train_id.shape[0]
        gen_net_id = Generator_z(seq_len=187, channels=1, latent_dim =100)
