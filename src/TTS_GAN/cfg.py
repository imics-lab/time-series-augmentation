...
def parse_args():
    ...
    #parser.add_argument('--class_name', type=str, default='Running')
...
#                         help='Generator Depth')
    ...
    parser.add_argument(
        ...
        type=str,
        default='./',
        help='The GAN model type')
    parser.add_argument(
        '--g_seq_len',
        type=int,
        default=150,
        help='length input signals to generator')
    parser.add_argument(
        '--g_channel',
        type=int,
        default=1,
        help='number of channels for input signals to generator')
    parser.add_argument(
        '--g_data_embed_dim',
        type=int,
        default=10,
        help='generator signal embeded dimension')
    parser.add_argument(
        '--g_depth',
        type=int,
        default=3,
        help='generator transformer block depth')
    parser.add_argument(
        '--g_num_heads',
        type=int,
        default=5,
        help='generator attention heads')    
    parser.add_argument(
        '--d_channel',
        type=int,
        default=1,
        help='number of channels for input signals to discriminator')
    parser.add_argument(
        '--d_patch_size',
        type=int,
        default=1,
        help='patch embedding size for signals input to discriminator')
    parser.add_argument(
        '--d_emb_size',
        type=int,
        default=50,
        help='data embed size for discriminator')
    parser.add_argument(
        '--d_seq_length',
        type=int,
        default=150,
        help='length input signals to discriminator')
    parser.add_argument(
        '--d_n_classes',
        type=int,
        default=1,
        help='number of ouput classes for discriminator') 
    parser.add_argument(
        '--d_depth',
        type=int,
        default=3,
        help='discriminator transformer block depth')
    parser.add_argument(
        '--d_num_heads',
        type=int,
        default=5,
        help='discriminator attention heads')
